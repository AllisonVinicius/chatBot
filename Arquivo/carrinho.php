	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		...
	    		<a href="home.php">Lista de Produtos</a>
	    	</div>
		</div>
		...
		<?php if($resultsCarts) : ?>
			...
			<a class="btn btn-info" href="shop.php">Continuar Comprando</a>
			<button class="btn btn-primary" type="submit">Atualizar Carrinho</button>
			<buttom class ="btn btn-primary" type="submit">Finaliza Compra</buttom>	
			</form>
